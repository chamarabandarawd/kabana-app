...
const Perks = ({ perks, setPerks }) => {
    ...
    return (
        <>
            ...
            <div className='border  border-green-300 flex gap-2 py-3 px-4 rounded-xl'>
                <input type='checkbox' name='free parking spot' className='cursor-pointer' onChange={handleCbClick}  />
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            <div className='border  border-green-300 flex gap-2 py-3 px-4 rounded-xl'>
                <input type='checkbox' name='pet' className='cursor-pointer' onChange={handleCbClick}  />
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            <div className='border  border-green-300 flex gap-2 py-3 px-4 rounded-xl'>
                <input type='checkbox' name='private entrance' className='cursor-pointer'  onChange={handleCbClick} />
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
